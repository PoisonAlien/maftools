...
Returned `ASCAT` object can be passed to downstream ASCAT functions. The below code chunk shows minimal usage with ASCAT. See [here](https://github.com/VanLoo-lab/ascat/tree/master/ExampleData) for further workflow examples. 
