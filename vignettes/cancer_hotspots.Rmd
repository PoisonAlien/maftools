...
output: 
  html_document:
    ...
    highlight: pygments
vignette: >
  %\VignetteIndexEntry{03: Somatic status of cancer hotspots}
...
`bamreadcounts` function extracts nucleotide distribution for targeted loci from the BAM files. The function name is an homage to [bam-readcount](https://github.com/genome/bam-readcount) tool and additionally supports INDELS.
...
loci_rc = maftools::bamreadcounts(bam = bamfile, loci = loci_file) 
