...
## Citation
Please cite the [below](https://doi.org/10.1101/gr.239244.118) if you find this tool useful for you.

```
Mayakonda A, Lin DC, Assenov Y, Plass C, Koeffler HP. 2018. Maftools: efficient and comprehensive analysis of somatic variants in cancer. [Genome Resarch](https://doi.org/10.1101/gr.239244.118). 
```
...
rainfallPlot(maf = brca, detectChangePoints = TRUE, fontSize = 12, pointSize = 0.6)
```
