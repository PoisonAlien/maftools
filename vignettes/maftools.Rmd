...
```{r, fig.align='left',fig.width=7, fig.height=5, eval=T, results='hide'}
...
A one-sided fishers exact test is also performed to statsitsically evaluate the enrichment score, as described in original study by Roberts et al.
