...
```{r}
##Extract data for samples 'TCGA.AB.3009' and 'TCGA.AB.2933' 
...
`addReadCounts` is wrapper script for bam-readcount programme, which takes MAF file as an input and adds read counts from the corresponding bam file [12](#references). `addReadCounts` assumes bam-readcount is installed and is under path. 
...
5.	Olshen AB, Venkatraman ES, Lucito R, Wigler M. Circular binary segmentation for the analysis of array-based DNA copy number data. Biostatistics. 2004;5(4):557–72. doi: 10.1093/biostatistics/kxh008.
