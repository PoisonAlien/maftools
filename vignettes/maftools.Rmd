...
[Genome Resarch](https://doi.org/10.1101/gr.239244.118)_**
...
=======
Draw elbow plot to visualize and estimate optimal number of signatures from above results.
...
```{r, eval=FALSE}
extractSignatures(mat = laml.tnm, n = 3)
>>>>>>> 4b144a2... Update signature analysis
```
