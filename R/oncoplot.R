...
#'
#' When pathways = 'auto', by default pathways defined by Bailey et al are plotted. See reference for details.
#' Please note that \code{OncogenicPathways}function uses signalling pathways (Sanchez-Vega et al) and is different from the one being used here.
#'
