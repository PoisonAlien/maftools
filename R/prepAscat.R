...
#' @seealso \code{\link{gtSNPs}} \code{\link{prep_ascat_t}} \code{\link{segmentLogR}}
...
#' @export
prepAscat = function(t_counts = NULL, n_counts = NULL, sample_name = NA, min_depth = 15, normalize = FALSE){
