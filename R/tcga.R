...
tcgaLoad = function(study = NULL, source = "MC3"){
  ...
  if(source == "MC3"){
    study.dat = paste0("https://github.com/PoisonAlien/TCGAmutations/blob/master/inst/extdata/MC3/",cohort, ".RDs?raw=true")
    ...
    study.dat = paste0("https://github.com/PoisonAlien/TCGAmutations/blob/master/inst/extdata/Firehose/",cohort, ".RDs?raw=true")
