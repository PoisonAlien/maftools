...
plotTiTv <- function(res = NULL, plotType = "both", sampleOrder = NULL,
  ...
  titv.frac.melt$variable <- factor(
    x = titv.frac.melt$variable,
  ...
  if (plotType == "bar") {
    ...
    b <- barplot(titv.frac.melt,
      col = col[rownames(x = titv.frac.melt)],
    ...
    par(mar = c(2, 4, 2, 2))
    b <- boxplot(value ~ variable,
      data = titv.frac.melt, axes = FALSE, xlab = "", ylab = "", col = col[levels(titv.frac.melt[, variable])],
      names = NA, lty = 1, staplewex = 0, pch = 16, xaxt = "n", notch = plotNotch,
      outcex = 0.6, outcol = "gray70", ylim = c(0, 100), lwd = 0.6
    )
    axis(
      side = 1, at = 1:length(levels(titv.frac.melt[, variable])), labels = levels(titv.frac.melt[, variable]),
    ...
    par(mar = c(2, 1.5, 2, 2))
    b <- boxplot(tf,
      axes = FALSE, xlab = "", ylab = "", col = "gray70",
      names = NA, lty = 1, staplewex = 0, pch = 16, xaxt = "n", notch = plotNotch,
      outcex = 0.6, outcol = "gray70", ylim = c(0, 100), lwd = 0.6
    )
    ...
    b <- barplot(titv.frac.melt,
      col = col[rownames(x = titv.frac.melt)], names.arg = rep("", ncol(titv.frac.melt)),
