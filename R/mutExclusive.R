...
#' @details This function runs \code{comet_exact_test()} internally between given genes and returns a table containing number of alterations with all possible combinations and significance value.
