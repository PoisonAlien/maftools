...
#' @param legend Logical. Hides legend if \code{FALSE}.
...
oncoprint = function(maf, genes = NULL, sort = T, legend = T, annotation = NULL, removeNonMutated = F, top = 5, showTumorSampleBarcodes = FALSE){
