...
#' @param pathways Can be a two column data.frame/tsv-file with genes and correspoding pathwaymappings. Default `NULL`, uses a predefined list of pathways. See reference for details.
