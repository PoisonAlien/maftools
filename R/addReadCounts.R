...
#'
#' @details This is a wrapper script which runs bam-readcount programme via R \code{system()} command to get readcounts.
...
addReadCounts = function(maf, bam_df, BaseQuality = 10, MapQuality = 10, ref_genome = NULL, skipSamples = NULL, samples = NULL){
