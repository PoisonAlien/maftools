...
#' @param fdrCutOff fdrCutoff used for while running GISTIC
...
readGistic = function(gisticAllLesionsFile = NULL, gisticAmpGenesFile = NULL, gisticDelGenesFile = NULL, gisticScoresFile = NULL, isTCGA = FALSE){
  ...
  message(paste0('Processing ', basename(gisticScoresFile), '..'))
