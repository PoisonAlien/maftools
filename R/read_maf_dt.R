...
read.maf = function(maf, removeSilent = TRUE, useAll = FALSE, gisticAllLesionsFile = NULL, gisticAmpGenesFile = NULL,
                    gisticDelGenesFile = NULL, cnTable = NULL, isTCGA = FALSE){
  ...
  #validate MAF file
  maf = validateMaf(maf = maf, isTCGA = isTCGA)
