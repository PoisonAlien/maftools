...
#' @sampleAnno annotations associated with each sample/Tumor_Sample_Barcode in MAF. Could be a text file or a data.frame
#' Ideally annotation would contain clinical data, survival information and other necessary features associated with samples. Default NULL.
